    ...
    <Fragment>
      ...
      >
        ...
        <Button variant='outline-info'>
          <Link to={routes.addUserPage}> Add User</Link>
        </Button>
      </div>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <Button
                      className='me-2'
                      variant='info'
                      onClick={() => showDetailDialogue(user)}
                    >
                      Details
                    </Button>
                    <Button className='me-2' variant='info'>
                      <Link to={`${routes.addUserPage}?userId=${user.id}`}>
                        {' '}
                        Edit
                      </Link>
                    </Button>
                    <Button variant='info' onClick={() => removeUser(user.id)}>
                      Delete
                    </Button>
                  </td>
                </tr>
